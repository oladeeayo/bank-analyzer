      ...
      <div className="w-full max-w-[480px]">
        <div className="bg-white rounded-2xl shadow-xl p-8 relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-20 h-12 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus-visible:ring-2 focus-visible:ring-gray-900/20 focus-visible:border-gray-900"
                  required
                />
                <button
                  type="submit"
                  className="absolute right-1 top-1/2 -translate-y-1/2 h-8 px-4 text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors"
                >
                  Continue
                </button>
              </div>
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl bg-gray-900 text-white hover:bg-gray-800 font-medium mt-2"
              disabled={loading}
            >
